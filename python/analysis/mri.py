...
fig.suptitle('MSE - Base de dados de Ressonância Magnética', y=0.95, fontsize=18, fontweight=60)
...
fig.suptitle('RMSE - Base de dados de Ressonância Magnética', y=0.95, fontsize=18, fontweight=60)
...
fig.suptitle('ERGAS - Base de dados de Ressonância Magnética', y=0.95, fontsize=18, fontweight=60)
...
ax1.plot(df_mri_specific_training['index'], polynomium_mri_specific_training(df_mri_specific_training['index']), '--', color=color_plot_polynomium_60_deg_specific_training, label='ERGAS - t. específico interpolado em 60º grau')
ax1.plot(df_mri_specific_training['index'], polynomium_mri_non_specific_training(df_mri_specific_training['index']), '--', color=color_plot_polynomium_60_deg_non_specific_training, label='ERGAS - t. genérico interpolado em 60º grau')
...
fig.suptitle('PSNR - Base de dados de Ressonância Magnética', y=0.95, fontsize=18, fontweight=60)
